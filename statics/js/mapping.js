    ...
    */
    ...
    $.ajax({
            ...
            success: function(data, textStatus, jqXHR){
                html = '<option value="" selected>Please select federation</option>'
                for (f in data){
            ...
            error: function(jqXHR, textStatus, errorThrown){
                console.log("ERROR: get federations list:", jqXHR)
    ...
    function show_datasource(fed){
        if (datasourcetable == null){
            ...
            datasourcetable.on( 'select', function ( e, dt, type, indexes ) {
                    selectedDatasourceRow = datasourcetable.rows( indexes ).data().toArray();
            ...
            selectedDatabaseName = null;
            selectedCollectionName = null;
            datasourcetable.ajax.url("api/datasources?graph=" + fed+ "&dstype=All").load();
        }
    }
